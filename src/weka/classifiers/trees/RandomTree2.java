 ...
 */
public class RandomTree2 extends Classifier implements OptionHandler,
  ...
  public void buildClassifier(Instances data) throws Exception {
    ...
    DecisionRule dRule = m_Tree.buildTree(train, classProbs, attIndicesWindow, rand, 0);
    decisionRule = dRule;
  ...
  protected class Tree implements Serializable {
     ...
     * @throws Exception if generation fails
     */
    protected DecisionRule buildTree(Instances data, double[] classProbs,
	  ...
	  if(m_Attribute != -1)
	  {
	      ...
	      decisionRule.setAttr(attr);
	      decisionRule.setSplitPoint(m_SplitPoint);
	  }
	  return decisionRule;
    }
