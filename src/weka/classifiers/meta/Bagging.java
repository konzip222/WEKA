...
import weka.classifiers.trees.DecisionRule;
...
public class Bagging extends RandomizableIteratedSingleClassifierEnhancer
  ...
  private List<RandomTree> listRTrees = new ArrayList<RandomTree>();
  ...
  public void buildClassifier(Instances data) throws Exception {
    ...
    for (int j = 0; j < m_Classifiers.length; j++) {
	  ...
	  RandomTree rTree = (RandomTree)m_Classifiers[j];
	  rTree.selected_rules = selected_rules_node;
	  rTree.buildClassifier(data);
	  selected_rules_node.add(rTree.attribute);
      listRTrees.add(rTree);
    }
...
//      Iterator iterator = listRTrees.entrySet().iterator();
//      int n = 0;
...
//  }
  ...
  public List<RandomTree> getRTrees()
  {
	  return listRTrees;
  }
